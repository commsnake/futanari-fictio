# Character Profile: Helen "The Old Man" Vance

## 1. Core Concept & Role
* **Role:** Ultimate Authority / Overarching Antagonist
* **Archetype:** The Sovereign / Unforgiving Matriarch
...
* **Voice Samples:**
    * *Sample 1 (Calm/Authoritative):* "The hold isn't full. We don't turn back until the hold is full. Understand?"
    * *Sample 2 (Angry/Tense):* "You don't make the rules here, boy. The ocean makes them, and I enforce them. Now, put it right."
    * *Sample 3 (Intimate/Aroused):* "You think this is a punishment? No. This is me making sure you know exactly who you belong to." (Spoken in a low, rumbling growl)

## 4. Conflict & Reaction Style
* **Conflict Style:** Utterly unmovable. She doesn't argue; she issues edicts. If challenged, she simply waits in terrifying silence until the challenger breaks or she issues a crushing physical command to the Deck Boss.
* **Resistance Style:** She does not experience resistance; she is the force others resist. When enforcing the "put it right" rule, she is methodical, slow, and overwhelming, acting with terrifying entitlement.
