...
def generate_character_profile(name, role, archetype, gender_config):
    ...
    # Logic for [Genre/Theme]/Erotica context
    if gender_config.lower() in ["female", "[genre/theme]"]:
        breast_size = generate_breast_size()
    else:
        breast_size = "N/A (Flat/Pecs)"

    if gender_config.lower() in ["male", "[genre/theme]"]:
...
if __name__ == "__main__":
    ...
    gender_configs = ["[Genre/Theme]", "Female", "Male"]
