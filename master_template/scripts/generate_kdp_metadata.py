...
def main():
    ...
    metadata += "*   **Standard 3 Image & Text Module:** Three 300 x 300 px images highlighting specific character traits or tropes (e.g., 'Alpha [Genre/Theme]', 'Blue Collar Romance', 'Size Difference').\n"
