...
Once a story idea is selected and generated, it should be organized into its own dedicated project folder (e.g., `My_[Genre/Theme]_Story_Book1/`) containing:
...
11. **`11_genre_theme_on_male_mechanics.md` (KB-11)**
    *   *Purpose:* Establishes instructions and adaptations for [Genre/Theme]-on-Male anal sex. Focuses on mechanics and sensory contrast.
