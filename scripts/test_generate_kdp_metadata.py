...
def test_generate_blurb():
    ...
    tropes = ["Size Difference", "Blue Collar", "Futanari"]
    ...
    assert "Size Difference, Blue Collar, Futanari" in blurb
...
def test_generate_keywords():
    tropes = ["Size Difference", "Blue Collar", "Futanari", "Mpreg", "Enemies to Lovers"]
    subgenre = "Contemporary"
